...
4. **Rank by evidence of US samples.** We review titles, abstracts and keywords, consulting full texts when available. The cohort has 1,035 distinct credited articles under this query: 473 have US-sample evidence and 169 remain geographically unclear. We combine explicit US recruitment statements with justified inference from study context, including American topics. The default ranking counts these US-evidence articles; total survey-experiment candidate counts remain available alongside it.
